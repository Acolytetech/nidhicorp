...
export default function Navbar() {
  ...
  return (
    <nav className="bg-gradient-to-br from-yellow-500 via-yellow-200 to-white shadow-md fixed w-full z-50 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            <Link
              href="/book"
              className="bg-yellow-400 text-white font-bold px-4 py-2 rounded-full shadow-md hover:bg-black transition-all duration-300"
            >
              Order Now
            </Link>
          </div>
      ...
      >
        {links.map((link) => (
          <Link
            ...
            onClick={() => setIsOpen(false)} // auto-close mobile menu
          >
            {link.name}
          </Link>
        ))}

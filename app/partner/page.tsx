...
import { Users, Handshake, TrendingUp } from "lucide-react"; // lucide icons
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <input
        ...
        className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 ${
          !formData.name ? "border-red-400" : "focus:ring-yellow-400"
        }`}
      />
      ...
      <input
        ...
        className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 ${
          !formData.email ? "border-red-400" : "focus:ring-yellow-400"
        }`}
      />
      ...
      <input
        ...
        className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 ${
          !formData.contact ? "border-red-400" : "focus:ring-yellow-400"
        }`}
      />
